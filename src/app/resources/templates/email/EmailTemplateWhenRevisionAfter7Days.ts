class EmailTemplateWhenRevisionAfter7Days {
    data: any;
                                        ...
                                        <tbody>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              <p
                                                class="text-center"
                                                style="color:#333;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin-top: 15px;margin-bottom:10px;padding:0;text-align:center"
                                              >
                                                          ...
                                                          <tbody>
                                                            ...
                                                            >
                                                              <th
                                                                ...
                                                                align="center"
                                                                style="color:#0a0a0a;float:none;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0 auto;padding:0px;padding-right:10px;text-align:center"
                                                              >
                                                                <a
    ...
    renderData() {
      ...
      >
      It seems that ${data.FirstNameStudent} has not completed the revision exercise allocated.
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
      Once ${data.FirstNameStudent} completes their revision exercise, you will gain insights on how your child perform compared to the year!
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center; margin-top: 35px;"
      >
      The revision exercise will be available for: 
      </p>
     
      <center
        data-parsed=""
        style="background-image:url('http://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/calendar.png');background-position:50% 50%;background-repeat:no-repeat;min-width:152px;width:152px; height:170px;margin: auto;"
      >
        <h1
          class="text-center"
          style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:40px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;padding-top:60px;text-align:center;word-wrap:normal"
        >
        ${data.dayLeft}
          <p
            class="text-center"
            style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
          >
            Days
          </p>
        </h1>
...
Object.seal(EmailTemplateWhenRevisionAfter7Days);
export default EmailTemplateWhenRevisionAfter7Days;