class EmailTemplateWhenStartNaplan {
    data: any;
    ...
    renderData() {
      ...
      >
      We've created a NAPLAN practice exam for ${data.FirstNameStudent} to prepare before their big day!
      </p>
      ...
      >
      The NAPLAN practice exam will be available for: 
      </p>
...
Object.seal(EmailTemplateWhenStartNaplan);
export default EmailTemplateWhenStartNaplan;