class EmailTemplateWhenStartRevision {
    data: any;
    ...
    renderData() {
      ...
      <p
        class="text-center"
        style="width: 80%;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center; margin: auto;"
      >
      We've created a revision exercise to re-cap on ${data.FirstNameStudent}'s learning throughout the term.
      </p>
      <p
        class="text-center"
      ...
      <center
        data-parsed=""
        style="background-image:url('http://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/calendar.png');background-position:50% 50%;background-repeat:no-repeat;min-width:152px;width:152px; height:180px;margin: auto;"
      >
        <h1
          class="text-center"
...
Object.seal(EmailTemplateWhenStartRevision);
export default EmailTemplateWhenStartRevision;