import {FocusType} from '../../../dataAccess/Enum';

class EmailTemplateWhenGameCompletesFocusCentre {
    data: any;
                                      ...
                                      <tbody>
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              Don't have our app yet? Download our
                                              parent app today!
                                            </p>
    ...
    renderData() {
        let data = this.data;
        if (!data || !data.MainConcepts || !data.FocusGroupType)
            return ''; 

        let focusTypeString = `<p>Our teachers have allocated the below exercises to help unleash ${data.FirstNameStudent}'s potential!</p>`;
        if (Number(data.FocusGroupType) === FocusType.Struggliing) {
          focusTypeString = ` <p>Our teachers have allocated the below exercises to help with ${data.FirstNameStudent}'s foundation.</p>`;
        }
        
        let concept = JSON.parse(data.MainConcepts);
      ...
      <table
        style="width: 80%; height: 30px;margin-left:auto;margin-right:auto;background-color: #ffffff;"
        cellspacing="1"
        cellpadding="15"
      >
        <tbody>
          <tr>
            ...
            >
              ${focusTypeString}
              <p>
                ${data.FirstNameStudent} was able to achieve the target that has been set.
              </p>
            </td>
          </tr>
        </tbody>
      ...
      <table
        style="width: 80%;margin-bottom:16px;margin-left:auto;margin-right:auto;"
        cellspacing="0"
        cellpadding="0"
      >
        <tbody>
            ...
            <td style="height: auto;">
              ...
              >
                <tbody>
                  <tr>
                    <td
                      style="background-color: #1691ed;text-align: center; color: #ffffff;"
                    >
                      <table
                        style="width: 100%; margin-left: auto; margin-right: auto;background-color: #1691ed;"
                        cellspacing="0"
                        cellpadding="2"
                      >
                        <tbody>
                            ...
                            >
                              ...
                              >
                                <tbody>
                                  <tr>
                                    <td
                                      style=" width: 3%; text-align: center; vertical-align: middle; background-color: #fff"
                                    >
                                      <img
                                        src="https://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/${concept.topicName}.png"
                                        style="width: 170px;"
                                      />
                                    </td>
                                    <td
                                      style=" width: 77%; text-align: left; vertical-align: middle; padding-left: 15px;"
                                    >
                                    ${concept.description}
                                     
                                    </td>
                                    <td
                                      style=" width: 20%; text-align: center; vertical-align: middle; color:#1691ed ;"
                                    >
                                      <table
                                        style="width: 100%; height: 160px; margin-left: auto; margin-right: auto; "
                                        cellspacing="1"
                                        cellpadding="0"
                                      >
                                        <tbody>
                                          <tr>
                                            <td
                                              style="text-align: center; vertical-align: middle;background-color: #fff;"
                                            >

                                            <table style="width: 100%; height: 93px; margin-left: auto; margin-right: auto; ">
                                              <tbody>
                                                <tr style="background-color: #f68f3b;color:#ffffff;">
                                                  <td style=" vertical-align: middle;font-size: 16px; margin: 0; text-align: center;">Target</td>
                                                </tr>
                                                <tr>
                                                  <td style="text-align: center; vertical-align: middle;"> ${data.Target}%</td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          ...
                                          <tr>
                                            ...
                                            <table style="width: 100%; height: 93px; margin-left: auto; margin-right: auto; ">
                                              <tbody>
                                                <tr style="background-color: #f68f3b;color:#ffffff;">
                                                  <td style=" vertical-align: middle;font-size: 16px; margin: 0;">Result</td>
                                                </tr>
                                                <tr>
                                                  <td style="text-align: center; vertical-align: middle;"> ${data.StudentPercent}%</td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            </td>
        ...
        <tbody>
          <tr>
            ...
            >
              ...
              <p>
                Log on to send an e-sticker to
                reward ${data.FirstNameStudent}!
              </p>
            </td>
          </tr>
        </tbody>
      ...
      <center>
        <a
          ...
          style="padding: 10px 20px;display: block;margin-top: 10px;background-color: #f68f3b; width: 150px;text-decoration: none; color: #fff; border-radius: 30px;"
          >Log on</a
        >
      </center>`;
...
Object.seal(EmailTemplateWhenGameCompletesFocusCentre);
export default EmailTemplateWhenGameCompletesFocusCentre; 