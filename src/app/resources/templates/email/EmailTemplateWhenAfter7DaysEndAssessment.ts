class EmailTemplateWhenAfter7DaysEndAssessment {
    data: any;
                                      ...
                                      <tbody>
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <p
                                              class="text-center"
                                              style="color:#333;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin-top:20px;margin-bottom:10px;padding:0;text-align:center"
                                            >
    ...
    renderData() {
      ...
      >
        It seems that ${data.FirstNameStudent}'s has not completed their assessment task allocated.
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
        Remind ${data.FirstNameStudent} to complete their assessment task to view their results when compared to their year.
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin-top:35px;margin-bottom:10px;padding:0;text-align:center"
      >
        The assessment task will expire in:
      </p>
      
      <center
        data-parsed=""
        style="background-image:url('https://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/calendar.png');background-position:50% 50%;background-repeat:no-repeat;min-width:152px;width:152px; height:170px;margin: auto;"
      >
        <h2
          class="text-center"
          style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:40px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;padding-top:55px;text-align:center;word-wrap:normal"
        >
        ${data.dayLeft}
          <p
            class="text-center"
...
Object.seal(EmailTemplateWhenAfter7DaysEndAssessment);
export default EmailTemplateWhenAfter7DaysEndAssessment;