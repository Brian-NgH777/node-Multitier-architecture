class EmailTemplateWhenAfter4DaysHomeWork {
    data: any;
    ...
    renderData() {
      ...
      <table
        style="width: 80%; height: 30px; margin-bottom:0px;margin-left:auto;margin-right:auto;background-color: #ffffff;"
        cellspacing="1"
        cellpadding="15"
      >
        <tbody>
          <tr>
            ...
            >
            ${data.FirstNameStudent} has yet to
        ...
        <tbody>
          <tr>
            <td
              ...
              style="height: 25px;text-align: center;"
            >
            <strong>The homework will be available
              for ${data.dayLeft} days.
              We've created the below
              exercises for ${data.FirstNameStudent}</strong>
            </td>
          </tr>
        </tbody>
      </table>`;
      ...
      <table
        class="callout"
        style="width: 80%; height: 0px; color: #fff;margin-bottom:16px;margin-left:auto;margin-right:auto;background-color: #1691ed;"
        cellspacing="2"
        cellpadding="7"
      >
        <tbody>
          <tr>
            <td style="width: 10%; background-color: #ffffff;">
              <span style="width: 135px;display: block;">
                <img
            ...
            <td
              style=" width: 65%; text-align: left; vertical-align: middle; color: #ffffff;"
            >
              <p style="margin: 0;font-size: 13px;width: 280px;">${item.description}</p>
            </td>
          </tr>
        </tbody>
      </table>`;
...
Object.seal(EmailTemplateWhenAfter4DaysHomeWork);
export default EmailTemplateWhenAfter4DaysHomeWork;