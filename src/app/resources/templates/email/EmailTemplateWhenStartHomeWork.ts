class EmailTemplateWhenStartHomeWork {
    data: any;
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          >
                            We've created some homework
                            exercises for ${data.FirstNameStudent}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td
                            ...
                            style="height: 25px;text-align: center;"
                          >
                          <strong>This week, ${data.FirstNameStudent} will be learning:</strong>
                          </td>
                        </tr>
                      </tbody>
                    </table>`;
...
Object.seal(EmailTemplateWhenStartHomeWork);
export default EmailTemplateWhenStartHomeWork; 