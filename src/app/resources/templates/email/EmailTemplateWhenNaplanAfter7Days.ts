class EmailTemplateWhenNaplanAfter7Days {
    data: any;
    ...
    renderData() {
      ...
      >
      It seems that ${data.FirstNameStudent} has not completed their NAPLAN practice exam!
      </p>
      ...
      >
      The NAPLAN practice exam will expire in:
      </p>
     
      <center
        data-parsed=""
        style="background-image:url('http://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/calendar.png');background-position:50% 50%;background-repeat:no-repeat;height:170px;min-width:532px;width:100%"
      >
        <h1
          class="text-center"
...
Object.seal(EmailTemplateWhenNaplanAfter7Days);
export default EmailTemplateWhenNaplanAfter7Days;