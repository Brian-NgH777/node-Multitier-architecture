class EmailTemplateWhenStartAssessment {
    data: any;
        ...
        <tbody>
          ...
          >
            ...
            >
              ...
              >
                We've create an assessment task to see
                how ${data.FirstNameStudent}'s has retained
                their learnings to date.
              </p>
              <p
                class="text-center"
              ...
              >
                The assessment task will be available
                for:
              </p>
...
Object.seal(EmailTemplateWhenStartAssessment);
export default EmailTemplateWhenStartAssessment;