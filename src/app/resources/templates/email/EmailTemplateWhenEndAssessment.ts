class EmailTemplateWhenEndAssessment {
    data: any;
    ...
    renderData() {
      ...
      >
        All students in our software has
      ...
      <table
        class="callout"
        style="width: 80%; height: 150px; color: #fff;margin-bottom:16px;margin-left:auto;margin-right:auto;background-color: #1691ed;"
        cellspacing="1"
        cellpadding="15"
      >
        <tbody>
          <tr>
            <td>
            ${data.FirstNameStudent}'s results
            </td>
            <td
              style="background-color: #f7f7f7; width: 30%; text-align: center; vertical-align: middle; font-size: 30px;color: #1691ed;"
            >
            ${data.BestMark || 0}%
            </td>
          </tr>
...
Object.seal(EmailTemplateWhenEndAssessment);
export default EmailTemplateWhenEndAssessment;