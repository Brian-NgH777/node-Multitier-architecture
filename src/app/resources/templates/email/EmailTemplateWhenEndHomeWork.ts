class EmailTemplateWhenEndHomeWork {
    data: any;
                  ...
                  >
                    <center data-parsed="" style="min-width:580px;width:100%">
                      ...
                      <table
                        ...
                        style="background:#f7f7f7;border-collapse:collapse;border-spacing:0;float:none;margin:0 auto;padding:0;text-align:center;vertical-align:top;width:600px"
                      >
                        <tbody>
                          <tr style="padding:0;text-align:left;vertical-align:top">
                            <td
                                        ...
                                        <tbody>
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                              Don’t have our app yet? Download our parent app today!
                                              </p>
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <a
                                                                  ...
                                                                  target="_blank"
                                                                  class="badge"
                                                                  style="color:#2199e8;display:block;float:left;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;max-width:135px;padding:0;padding-bottom:5px;padding-left:5px;padding-right:5px;padding-top:0;text-align:left;text-decoration:none;width:100%"
                                                                  ><img
                                                                    class="badge"
                                                                    src="http://gameasset.s3.amazonaws.com/EmailTemplate/appstore.png"
                                                                    style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;float:left;max-width:135px;outline:0;padding-bottom:5px;padding-left:5px;padding-right:5px;padding-top:5px;text-decoration:none;width:100%"/></a
                                                                ><a
                                                                  ...
                                                                  ><img
                                                                    ...
                                                                    style="-ms-interpolation-mode:bicubic;border:none;clear:both;display:block;float:left;max-width:135px;outline:0;padding-bottom:5px;padding-left:5px;padding-right:5px;padding-top:5px;text-decoration:none;width:100%"
                                                                /></a>
                                                              </th>
                                                            </tr>
                                                          </tbody>
    ...
    renderData() {
      ...
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
        Here are the results of
        ${data.FirstNameStudent}'s year:
      </p>
      <table
        class="spacer"
        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%"
      ...
      >
        <strong
          >Here's how ${data.FirstNameStudent} performed this
          week.</strong
        >
      </p>
    ...
    >
      ...
      <table
        class="callout"
        style="width: 80%; height: 120px; color: #fff;margin-bottom:16px;margin-left:auto;margin-right:auto;background-color: #1691ed;"
        cellspacing="1"
        cellpadding="10"
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Homework status</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
              <p style="margin: 0;font-size: 13px;width: 115px; margin: 0 auto;">${data.Status}</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Time spent completing</br> questions</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
              <p style="font-size: 28px; margin: 0;width: 115px;margin: 0 auto;">${data.TimeSpentStudent|| 0}</p> Minutes
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Questions completed</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
            <p style="font-size: 28px; ;width: 115px;margin: 0 auto;">${data.QuestionsCompleted|| 0}</p> 
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Accuracy</span>
              
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
            <p style="font-size: 28px; width: 115px;margin: 0 auto;">${data.Accuracy|| 0}%</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <strong
          >How did ${data.FirstNameStudent} compare
          with ${data.Name}?</strong
        >
      </p>

      <table
        class="callout"
        style="width: 80%; height: 120px; color: #fff;margin-bottom:16px;margin-left:auto;margin-right:auto;background-color: #ff970e;"
        cellspacing="1"
        cellpadding="15"
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Average time spent completing
                questions</span>
              
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #ff970e;"
            >
            <p style="font-size: 28px; width: 115px;margin: 0 auto;">${data.TimeSpentAvgClass|| 0}</p>Minutes
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Average questions completed</span>
              
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #ff970e;"
            >
            <p style="font-size: 28px; width: 115px;margin: 0 auto;">${data.QuestionsCompletedAvgClass|| 0}</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Average accuracy</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #ff970e;"
            >
            <p style="font-size: 28px; width: 115px;margin: 0 auto;">${data.AccuracyAvgClass|| 0}%</p>
            </td>
          </tr>
        </tbody>
      </table>
...
Object.seal(EmailTemplateWhenEndHomeWork);
export default EmailTemplateWhenEndHomeWork;