...
class EmailTemplateWhenGameCompletesNaplan {
    data: any;
    ...
    renderData() {
      ...
      >
      ${data.FirstNameStudent} has completed their first NAPLAN practice exam!
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
      Log on to view ${data.FirstNameStudent}'s results and reward them with an e-sticker!
      </p>
...
Object.seal(EmailTemplateWhenGameCompletesNaplan);
export default EmailTemplateWhenGameCompletesNaplan; 