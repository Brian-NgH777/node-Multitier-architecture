class EmailTemplateWhenEndNaplan {
    data: any;
    ...
    changeBand(percentage, yearGrade) {
      if (yearGrade === 3) {
          if (percentage >= 0 && percentage <= 23)
              return 'Band 1';
          if (percentage >= 24 && percentage <= 35)
              return 'Band 2';
          if (percentage >= 36 && percentage <= 46)
              return 'Band 3';
          if (percentage >= 47 && percentage <= 59)
              return 'Band 4';
      ...
      if (yearGrade === 5) {
          ...
          if (percentage >= 51 && percentage <= 65)
              return 'Band 6';
          if (percentage >= 66 && percentage <= 78)
              return 'Band 7';
          if (percentage >= 79 && percentage <= 100)
              return 'Band 8';
      }
    ...
    renderData() {
      ...
      >
      All students in our software has completed their NAPLAN practice exam!
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
      Here are the results of ${data.FirstNameStudent}'s year:
      </p>
      <table
        class="spacer"
        style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%"
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">${data.FirstNameStudent}'s results</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
              <p style="margin: 0;font-size: 24px;width: 115px; margin: 0 auto;">${this.changeBand(data.BestMark || 0, data.YearGrade)}</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Year average</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
              <p style="margin: 0;font-size: 28px;width: 115px; margin: 0 auto;">${this.changeBand(data.ClassAverage || 0, data.YearGrade)}</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        <tbody>
          <tr>
            <td style="width: 65%">
              <span style="width: 200px;display: block;">Top performing students</span>
            </td>
            <td
              style="background-color: #ffffff; width: 35%; text-align: center; vertical-align: middle; color: #1691ed;"
            >
              <p style="margin: 0;font-size: 28px;width: 115px; margin: 0 auto;">${this.changeBand(data.TopMark || 0, data.YearGrade)}</p>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <center
        style="min-width:532px;width:100%; margin-top: 35px;"
      >
        <p
          class="text-center"
          style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
        >
          Log on to view more results!
        </p>
        <a
          href="https://parent.starmathsonline.com.au/"
          style="background-color:#f68f3b;border-radius:30px;color:#fff;display:block;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;margin-top:10px; margin-bottom: 35px;padding:10px 20px;text-align:center;text-decoration:none;width:150px"
          >Log on</a
        >
      </center>`;
...
Object.seal(EmailTemplateWhenEndNaplan);
export default EmailTemplateWhenEndNaplan;