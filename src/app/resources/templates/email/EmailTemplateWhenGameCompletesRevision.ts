...
class EmailTemplateWhenGameCompletesRevision {
    data: any;
    ...
    renderData() {
      ...
      >
      ${data.FirstNameStudent} has completed the revision exercise allocated
      </p>
      <p
        class="text-center"
        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:center"
      >
      Log on to reward ${data.FirstNameStudent} with an e-sticker!
      </p>
      
      <center
        data-parsed=""
      >
       <img src="https://gameasset.s3.amazonaws.com/EmailTemplate/Assessment/Asset_163.png"/>
      </center>
      <center>
        <a href="https://parent.starmathsonline.com.au/" style="padding: 10px 20px;display: block;margin-top: 10px;background-color: #f68f3b; width: 150px;text-decoration: none; color: #fff; border-radius: 30px;">Log on</a>
      </center>`;
...
Object.seal(EmailTemplateWhenGameCompletesRevision);
export default EmailTemplateWhenGameCompletesRevision; 